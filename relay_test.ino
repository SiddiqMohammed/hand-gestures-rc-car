...
// CAR FWD = IN1 = 1 [as input]
// CAR REV = IN2 = 2 [as input]
// CAR FR  = IN3 = 3 [as input]
// CAR FL  = IN4 = 4 [as input]
// CAR RR  = IN4 = 5 [as input]
// CAR RL  = IN4 = 6 [as input]
// CAR STP = 7-8 [as input]
// QUIT = 9 [as input]
...
if(serialData > 0){
  ...
  //   loop();
  // }
  // if(serialData == '3'){          // FWD + Right Motion
  //   Serial.print(serialData);
  //   digitalWrite(11, HIGH);       // Wheels turn Right [11]
  //   delay(100);
  //   digitalWrite(9, HIGH);        // FWD Motion is activated [10]
  ...
  //   loop();
  // }
  // if(serialData == '4'){          // FWD + Left Motion
  //   Serial.print(serialData);
  //   digitalWrite(12, HIGH);
  //   delay(100);
  //   digitalWrite(9, HIGH);        // FWD Motion is activated [10]
  ...
  //   loop();
  // }
  // if(serialData == '5'){          // RVS + Left Motion
  //   Serial.print(serialData);
  //   digitalWrite(12, HIGH);
  //   delay(100);
  //   digitalWrite(10, HIGH);       // FWD Motion is activated [10]
  ...
  //   loop();
  // }
  // if(serialData == '6'){          // RVS + Left Motion
  //   Serial.print(serialData);
  //   digitalWrite(12, HIGH);
  //   delay(100);
  //   digitalWrite(10, HIGH);       // FWD Motion is activated [10]
